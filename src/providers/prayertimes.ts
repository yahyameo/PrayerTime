...
export class PrayerTimeTime {
  ...
  toDate(baseDate: Date = new Date()): Date {
    return new Date(baseDate.getFullYear(), this.month, this.day, this.hours, this.minutes, 0, 0);
  }
...
export class PrayerTimeDay {
  ...
  constructor(data: string[], options){
    ...
    this.maghrib = new PrayerTimeTime(data[6], 'maghrib', this.day, this.month);
    this.isha = new PrayerTimeTime(data[7], 'isha', this.day, this.month);
...
export class PrayerTimes{
 ...
 alert.addInput({
          ...
          label: 'Stockholm',
          value: 'stockholm',
          checked: previousLocation === 'stockholm'
        });
        alert.addInput({
          type: 'radio',
          label: 'Heisenberg',
          value: 'heisenberg',
          checked: previousLocation ? (previousLocation === 'heisenberg') : true
        });
